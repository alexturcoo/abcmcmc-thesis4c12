...
\label{methods}
%All custom scripts and commands used in this
%analysis can be found on \texttt{GitHub} at
...
%\subsection{LCR Simulation}

%\subsection{Confidence Intervals for Correlation Coefficient}
