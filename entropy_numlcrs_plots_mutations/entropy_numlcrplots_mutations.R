...
df_1000_im1_ii0.01 <- read.delim("10_distances_im0.01_ii1.txt", header = FALSE)
df_1000_im1_ii0.1 <- read.delim("10_distances_im0.1_ii1.txt", header = FALSE)
df_1000_im1_ii0.5 <- read.delim("10_distances_im0.5_ii1.txt", header = FALSE)
df_1000_im1_ii1 <- read.delim("10_distances_im1_ii1.txt", header = FALSE)
df_1000_im1_ii2 <- read.delim("10_distances_im2_ii1.txt", header = FALSE)
df_1000_im1_ii10 <- read.delim("10_distances_im10_ii1.txt", header = FALSE)
...
jpeg("m0.01-0.1-0.5.jpeg", units="in", width=12, height=6, res=300)
ggarrange(ggarrange(pSmall1, pSmall2, ncol = 2, labels = c("im0.01", "im0.1")), pSmall3, 
          labels = c("","im0.5"), nrow = 2)
dev.off()

jpeg("m1-2-10.jpeg", units="in", width=12, height=6, res=300)
ggarrange(ggarrange(pSmall4, pSmall5, ncol = 2, labels = c("im1", "im2")), pSmall6, 
          labels = c("","im10"), nrow = 2)
dev.off()
